<template>
    <div class="reservation-layout">
        ...
        <div class="sports-sidebar">
            <div class="sport-icon" v-for="sport in sports" :key="sport.name" @click="currentSport = sport.name"
        ...
        <div class="venue-section">
            ...
            <div class="venue-item" v-for="venue in filteredVenues" :key="venue.id">
